...
//     const mod = b.addModule("salt_crkl", .{
...
//             // root module.
//             .imports = &.{
//                 // Here "salt_crkl" is the name you will use in your source code to
//                 // import this module (e.g. `@import("salt_crkl")`). The name is
//                 // repeated because you are allowed to rename your imports, which
//                 // can be extremely useful in case of collisions (which can happen
//                 // importing modules from different packages).
//                 .{ .name = "salt_crkl", .module = mod },
//             },
//         }),
//     });
